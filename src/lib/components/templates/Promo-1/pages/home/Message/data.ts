...
export const MESSAGE_DEFAULT_TEXT =
	'Работы, которые уже стоят у наших заказчиков. У каждой — свой замер, свои материалы и своя дата сдачи: откройте проект и посмотрите, из чего он собран и сколько занял.';
