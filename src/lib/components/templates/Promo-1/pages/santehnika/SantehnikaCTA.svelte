...
<div class="mebel-container mb-16 mt-12">
	<div class="rounded-2xl bg-linear-to-r from-sky-500 to-cyan-600 p-8 text-center text-white sm:p-12">
		<h2 class="text-2xl font-bold sm:text-3xl">
			<EditableField fieldKey="SantehnikaCTA.title" label="Заголовок CTA"
		...
		<p class="mx-auto mt-3 max-w-md text-sky-100">
			<EditableField fieldKey="SantehnikaCTA.description" label="Описание CTA"
				value={String(data.description || 'Наши специалисты помогут подобрать сантехнику под вашу кухню и бюджет')}
		...
		<div class="mt-6 flex flex-wrap justify-center gap-4">
			<button class="inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 font-medium text-sky-600 transition-all hover:bg-sky-50">
				<EditableField fieldKey="SantehnikaCTA.buttonText" label="Текст кнопки"
