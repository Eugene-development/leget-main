...
<section class="relative isolate overflow-hidden bg-ink-950 py-24 sm:py-28 lg:py-32">
	<div class="pointer-events-none absolute inset-0" aria-hidden="true">
		...
		<div class="gt-glow absolute -right-24 -bottom-40 size-112 bg-cat-5-400/15"></div>
		<div
			class="absolute inset-x-0 top-0 mx-auto h-px w-2/3 bg-linear-to-r from-transparent via-cat-2-400/60 to-transparent"
		></div>
		<div
	...
	<div class="relative mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
		...
		<div
			use:revealOnScroll
			class="gt-reveal gt-card rounded-4xl bg-linear-to-br from-cat-2-400/40 via-cat-9-300/25 to-cat-5-400/40 p-px shadow-[0_50px_120px_-60px_rgba(16,185,129,0.55)]"
		>
			<div
			...
			>
				...
				<div class="relative">
					<div
						class="gt-item mx-auto flex size-16 items-center justify-center rounded-2xl bg-linear-to-br from-cat-2-400 to-cat-5-500 text-on-accent shadow-[0_20px_50px_-20px_rgba(16,185,129,0.9)] ring-1 ring-on-accent/20"
					>
						<svg
							class="size-8"
							fill="none"
					...
					>
						{#snippet children(displayValue)}
							<p
								class="inline-flex items-center gap-3 text-[11px] font-semibold tracking-[0.28em] text-cat-2-300 uppercase sm:text-xs"
							>
								<span class="h-px w-8 bg-cat-2-400/80" aria-hidden="true"></span>
								{displayValue}
								<span class="h-px w-8 bg-cat-2-400/80" aria-hidden="true"></span>
							</p>
						{/snippet}
					...
					<div
						class="gt-rule gt-d3 mx-auto mt-6 flex max-w-xs items-center gap-3"
						aria-hidden="true"
					>
						<span class="h-px flex-1 bg-on-dark/15"></span>
						<span class="size-1.5 rotate-45 border border-cat-2-400/80"></span>
						<span class="h-px flex-1 bg-on-dark/15"></span>
					</div>
					...
					<div
						class="gt-item gt-d4 mt-10 flex flex-wrap items-center justify-center gap-3 sm:gap-4"
					>
						<a
							href="/contact"
							class="group inline-flex items-center justify-center gap-2.5 rounded-full bg-linear-to-r from-cat-2-500 to-cat-5-500 px-7 py-3.5 text-sm font-semibold text-on-accent shadow-[0_18px_45px_-18px_rgba(16,185,129,0.95)] transition duration-300 hover:from-cat-2-400 hover:to-cat-5-400 hover:shadow-[0_22px_55px_-16px_rgba(16,185,129,1)] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-cat-2-300 motion-safe:hover:-translate-y-0.5"
						>
							<EditableField
