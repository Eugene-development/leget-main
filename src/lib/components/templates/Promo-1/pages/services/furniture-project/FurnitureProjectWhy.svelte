<script lang="ts">
	// Артикул: 1.14.3.1 — см. docs/architecture/component-articles-map.md
...
<section class="bg-ink-50 py-24 sm:py-32">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="grid items-center gap-16 lg:grid-cols-2">
			...
			<div class="relative">
				<div
					class="absolute -right-6 -bottom-6 size-48 rounded-[2.5rem] bg-cat-8-500 lg:size-64"
				></div>
				<div class="absolute -top-4 -left-4 size-32 rounded-full bg-cat-8-500/30 blur-2xl"></div>
				<div
				...
				>
					<img
						...
						src={String(
							data?.imageUrl ??
								'https://storage.yandexcloud.net/leget-main/templates/promo-1/furniture_design_process.png'
						)}
						alt="Мебель на заказ"
				...
				<dl class="mt-12 space-y-10">
					{#each reasons as item, i}
						<div class="group flex gap-8">
							<dt
								class="text-5xl font-black text-cat-8-500/20 transition-colors duration-300 group-hover:text-cat-8-500"
							>
								{item.num}
							</dt>
							<dd class="pt-1">
