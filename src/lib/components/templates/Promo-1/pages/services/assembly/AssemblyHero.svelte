...
<section class="relative h-[calc(100vh-88px)] flex items-center overflow-hidden bg-slate-950">
	...
	<div class="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 w-full">
		<div class="grid items-center gap-12 lg:grid-cols-12 lg:gap-20">
					...
					>
						{#snippet children(displayValue)}
							<button
								...
								class="group relative inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-rose-500 to-pink-600 px-8 py-4 text-base font-bold text-white shadow-xl shadow-rose-500/20 transition-all duration-300 hover:scale-105 hover:shadow-rose-500/40 active:scale-95 cursor-pointer"
							>
			...
			<div class="relative hidden lg:col-span-6 lg:justify-self-end lg:block w-full" in:fly={{ x: 50, duration: 1000, delay: 200, easing: cubicOut }}>
