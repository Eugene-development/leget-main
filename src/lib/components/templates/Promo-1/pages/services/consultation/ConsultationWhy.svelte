<script lang="ts">
	// Артикул: 1.11.3.1 — см. docs/architecture/component-articles-map.md
			...
			: [
					{
						...
						desc: 'Избежите дорогих ошибок при выборе мебели и материалов'
					},
					{
						num: '02',
						title: 'Чёткое видение',
						desc: 'Получите понятный план действий ещё до начала ремонта'
					},
					{
						num: '03',
						title: 'Индивидуальный подход',
						desc: 'Решения, учитывающие ваш образ жизни и предпочтения'
					}
				]
	);
