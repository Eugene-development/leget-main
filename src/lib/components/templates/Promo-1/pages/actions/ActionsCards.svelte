	...
	const defaultCards: Card[] = [
		{
			...
			description: 'Наш специалист бесплатно приедет к вам на объект в пределах города и даст подробную консультацию.',
			badge: 'Бесплатно',
		...
		},
		{
			...
			description: 'Осуществим замер с указанием углов, розеток и вывода воды. Его стоимость вычтем из договора.',
		...
		},
		{
			...
			description: 'При приобретении у нас бытовой техники мы подключим её к коммуникациям за счёт компании.',
			badge: 'Бесплатно',
		...
		},
		{
			id: 'design',
			title: 'Дизайн-проект',
			description: 'Дизайнер бесплатно составит проект мебели в соответствии с замером и вашими пожеланиями.',
			badge: 'Бесплатно',
		...
		},
		{
			...
			description: 'Предложим вам в подарок каждую пятую позицию бытовой техники, приобретённую у нас.',
			badge: 'Подарок',
		...
		},
		{
			...
			description: 'Только что приобрели жильё? Дарим дополнительную скидку на покупку кухонного гарнитура или шкафа при предъявлении выписки ЕГРН.',
			badge: 'Скидка 10%',
		...
		},
		{
			...
			description: 'Вы можете заказать всю необходимую мебель сейчас, а оплачивать её комфортными частями до 12 месяцев без первого взноса и процентов.',
			badge: 'Рассрочка 0%',
