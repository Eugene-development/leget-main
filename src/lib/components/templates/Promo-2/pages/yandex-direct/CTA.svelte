...
>
	...
	<div class="absolute top-0 right-0 left-0 h-px bg-linear-to-r from-transparent via-accent/50 to-transparent"></div>
	...
	<div class="relative mx-auto max-w-3xl px-6 text-center xl:px-1">
		<div class="opacity-0 transition-all duration-700" class:animate-fade-up={visible}>
			...
			<!-- Trust badges -->
			<div class="mt-12 flex flex-wrap items-center justify-center gap-8 border-t border-white/10 pt-8">
