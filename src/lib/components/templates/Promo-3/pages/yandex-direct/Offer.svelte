...
<section class="relative overflow-hidden py-24 lg:py-32">
	<div class="absolute inset-0 bg-linear-to-br from-accent-600/10 via-surface-900 to-surface-900"></div>
	<div
	...
	<div class="relative px-10 lg:px-24 xl:px-32">
		<div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
			...
			<div class="relative rounded-3xl border border-surface-700/50 bg-surface-800/50 p-8 shadow-2xl backdrop-blur-sm lg:p-10">
				...
				<div class="absolute -bottom-px right-10 h-px w-20 bg-linear-to-r from-transparent via-accent-500/50 to-transparent"></div>

				<p class="mb-8 text-xs font-semibold tracking-[0.3em] text-accent-500 uppercase">В стоимость входит</p>
