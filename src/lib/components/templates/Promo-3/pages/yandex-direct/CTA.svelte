...
<section class="relative overflow-hidden py-24 lg:py-32">
	<div
		class="absolute inset-0 bg-linear-to-br from-accent-600/20 via-surface-900 to-surface-900"
	></div>
	<div
	...
	<div class="relative px-8 text-center lg:px-16 xl:px-20">
		...
		>
			{#snippet children(displayValue)}
				<h2 class="font-display mt-4 text-4xl text-white lg:text-5xl">
					{displayValue}
				</h2>
			{/snippet}
		</EditableField>
		...
		<!-- Trust row -->
		<div
			class="mx-auto mt-16 flex max-w-lg flex-wrap items-center justify-center gap-8 border-t border-surface-700/50 pt-8"
		>
