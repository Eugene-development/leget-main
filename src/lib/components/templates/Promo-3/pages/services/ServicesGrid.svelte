<script lang="ts">
	// Артикул: 3.7.2.1 — см. docs/architecture/component-articles-map.md
	...
	const defaultServices = [
		{
			...
			title: 'Доставка',
			description:
				'Быстрая и бережная доставка плитки, сантехники и отделочных материалов прямо на объект. Работаем по городу и области, обеспечиваем сохранность груза.',
		...
		},
		{
			...
			title: 'Плиточник',
			description:
				'Профессиональная укладка плитки, керамогранита и мозаики. Опытные мастера с портфолио готовых объектов — ванные, кухни, прихожие, фасады.',
			...
			features: [
				'Укладка любого формата и сложности',
				'Точная подрезка и стыковка',
		...
		},
		{
			...
			title: 'Сантехник',
			description:
				'Монтаж и подключение сантехники: ванны, душевые кабины, унитазы, раковины, смесители. Качественные работы с соблюдением всех норм и стандартов.',
		...
		},
		{
			...
			description:
				'Разработка авторских дизайн-проектов: концепция, планировочное решение, подбор отделочных материалов, 3D-визуализация.',
		...
		},
		{
			...
			title: 'Подбор мебели',
			description:
				'Помогаем выбрать мебель, которая гармонично впишется в интерьер: ванные комнаты, кухни, гостиные. Работаем с ведущими производителями по выгодным ценам.',
			...
			features: [
				'Подбор под дизайн-проект',
				'Каталог сотен коллекций',
	...
	const services = $derived(
		Array.isArray(data?.services) && (data.services as unknown[]).length > 0
			? (data.services as typeof defaultServices)
			: defaultServices
	);
</script>
