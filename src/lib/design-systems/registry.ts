...
export const DESIGN_SYSTEMS: readonly DesignSystemEntry[] = [
	...
	},
	{
		...
		inDatabase: true,
		description:
			'Белая мастерская: ахроматичная нейтраль без подтона, единственный хроматический ' +
			'акцент — индиго, волосяные линии вместо теней и один рецепт тени на то, что ' +
			'действительно парит. Заголовок набран антиквой, интерфейс — гротеском. Скругление ' +
			'бинарное: либо резкое, либо крупное, без промежутка. Выведена из внешнего style ' +
			'reference; опубликована для Promo-1 миграцией seed_and_publish_iris_for_promo1. ' +
			'Единственная система с собственным @font-face (Source Serif 4) — сборку фронта ' +
			'выкатывать ДО прогона миграции, иначе заголовок уедет на системный шрифт.'
	}
] as const;
